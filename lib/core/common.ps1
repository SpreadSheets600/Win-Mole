...
if ((Get-Variable -Name 'WINMOLE_COMMON_LOADED' -Scope Script -ErrorAction SilentlyContinue) -and $script:WINMOLE_COMMON_LOADED) { 
    return 
}
$script:WINMOLE_COMMON_LOADED = $true

# Get the directory containing this script
$script:WINMOLE_CORE_DIR = Split-Path -Parent $MyInvocation.MyCommand.Path
$script:WINMOLE_LIB_DIR = Split-Path -Parent $script:WINMOLE_CORE_DIR
$script:WINMOLE_ROOT_DIR = Split-Path -Parent $script:WINMOLE_LIB_DIR
...
. "$script:WINMOLE_CORE_DIR\base.ps1"

# Logging functions
. "$script:WINMOLE_CORE_DIR\log.ps1"

# Safe file operations
. "$script:WINMOLE_CORE_DIR\file_ops.ps1"

# UI components
. "$script:WINMOLE_CORE_DIR\ui.ps1"

# ============================================================================
# Version Information
# ============================================================================

$script:WINMOLE_VERSION = "0.1.1"
$script:WINMOLE_BUILD_DATE = "2026-07-31"

function Get-WinMoleVersion {
    <#
    .SYNOPSIS
        Get WinMole version information
    #>
    return @{
        Version   = $script:WINMOLE_VERSION
        BuildDate = $script:WINMOLE_BUILD_DATE
...
function Initialize-WinMole {
    <#
    .SYNOPSIS
        Initialize WinMole environment
    #>
    ...
    Write-Debug "WinMole initialized"
